...
#load images - BackGround Paralaxe
...
for x in range(TILE_TYPES):
	img = pygame.image.load(f'Ilan/img/tile/{x}.png').convert_alpha()
...
def create_platforms(level_data): #Create Plateform par Bloc 
    platforms = []
...
while running:
    ...
    for platform in platforms:
        platform.Display(screen,[0,0] )
    
    
    # Met à jour et dessine le joueur
    player.Movement(17)
    player.DisplayPlayer(screen, [0,0])
