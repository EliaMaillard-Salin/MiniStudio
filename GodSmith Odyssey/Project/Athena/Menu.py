...
class Menu :
    def __init__(self, width, height):
        ...
        self.quit = False
        #IMG QUIT
        self.img_quit1 = py.image.load("GodSmith Odyssey/Project/Athena/Button/QUIT1.png")
        self.img_quit = py.image.load("GodSmith Odyssey/Project/Athena/Button/QUIT.png")
        #IMG OPTION
        self.img_option1 = py.image.load("GodSmith Odyssey/Project/Athena/Button/OPTION1.png")
        self.img_option = py.image.load("GodSmith Odyssey/Project/Athena/Button/OPTION.png")
        #IMG RESTART
        self.img_restart1 = py.image.load("GodSmith Odyssey/Project/Athena/Button/RESTART1.png")
        self.img_restart = py.image.load("GodSmith Odyssey/Project/Athena/Button/RESTART.png")
