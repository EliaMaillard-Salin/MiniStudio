...
class Boss:
    def __init__(self, x,y,c,w,h,p):
        ...
        #Animations
        self.walk = ["GodSmith Odyssey/Project/Athena/AnimAthena/Anim Marche/Marche 1 sur 2.png", "GodSmith Odyssey/Project/Athena/AnimAthena/Anim Marche/Marche 2 sur 2.png"]
        self.walk_nb = 0
        self.attack_anim = ["GodSmith Odyssey/Project/Athena/AnimAthena/Anim Attaque/Pose Début.png","GodSmith Odyssey/Project/Athena/AnimAthena/Anim Attaque/Préparation Attaque.png",
                            "GodSmith Odyssey/Project/Athena/AnimAthena/Anim Attaque/Attaque 1 sur 2.png","GodSmith Odyssey/Project/Athena/AnimAthena/Anim Attaque/Attaque 2 sur 2.png",
                            "GodSmith Odyssey/Project/Athena/AnimAthena/Anim Attaque/Pose Fin.png"]
        self.attack_nb = 0
        self.parry_anim = ["GodSmith Odyssey/Project/Athena/AnimAthena/Anim Contre/Garde.png"]
        self.parry_nb = 0
        self.aoe_anim = ["GodSmith Odyssey/Project/Athena/AnimAthena/Anim Onde/Lancé 1 sur 3.png",
                         "GodSmith Odyssey/Project/Athena/AnimAthena/Anim Onde/Lancé 2 sur 3.png","GodSmith Odyssey/Project/Athena/AnimAthena/Anim Onde/Lancé 3 sur 3.png",
                         "GodSmith Odyssey/Project/Athena/AnimAthena/Anim Onde/Onde 1 sur 5.png","GodSmith Odyssey/Project/Athena/AnimAthena/Anim Onde/Onde 2 sur 5.png",
                         "GodSmith Odyssey/Project/Athena/AnimAthena/Anim Onde/Onde 3 sur 5.png","GodSmith Odyssey/Project/Athena/AnimAthena/Anim Onde/Onde 4 sur 5.png",
                         "GodSmith Odyssey/Project/Athena/AnimAthena/Anim Onde/Onde 5 sur 5.png","GodSmith Odyssey/Project/Athena/AnimAthena/Anim Onde/Récup 1 sur 5.png",
                         "GodSmith Odyssey/Project/Athena/AnimAthena/Anim Onde/Récup 2 sur 5.png","GodSmith Odyssey/Project/Athena/AnimAthena/Anim Onde/Récup 3 sur 5.png",
                         "GodSmith Odyssey/Project/Athena/AnimAthena/Anim Onde/Récup 4 sur 5.png","GodSmith Odyssey/Project/Athena/AnimAthena/Anim Onde/Récup 5 sur 5.png",]
        self.aoe_nb = 0
        self.idle_anim = ["GodSmith Odyssey/Project/Athena/AnimAthena/Anim Idle/Stand 1.png","GodSmith Odyssey/Project/Athena/AnimAthena/Anim Idle/Stand 2.png"]
        self.idle_nb = 0
        self.idle_time = 0
        self.provoc_anim = ["GodSmith Odyssey/Project/Athena/AnimAthena/Anim Provoc/Provoc 1 sur 2.png","GodSmith Odyssey/Project/Athena/AnimAthena/Anim Provoc/Provoc 2 sur 2.png"]
        self.provoc_nb = -1
        self.provoc_time = 0
        self.onde_anim = ["GodSmith Odyssey/Project/Athena/AnimAthena/Effet Onde/Effet 1 sur 2.png","GodSmith Odyssey/Project/Athena/AnimAthena/Effet Onde/Effet 2 sur 2.png"]
        self.onde_nb = 0
