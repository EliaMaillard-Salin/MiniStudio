...
sky_img : pygame.Surface = pygame.image.load('GodSmith Odyssey/Project/Assets/PNG/Background.png').convert_alpha()
...
for x in range(TILE_TYPES):
	img = pygame.image.load(f'GodSmith Odyssey/Project/Assets/PNG/Blocs/{x}.png').convert_alpha()
	img = pygame.transform.scale(img, (TILE_SIZE, TILE_SIZE))
	img_list.append(img)

save_img : pygame.Surface = pygame.image.load('GodSmith Odyssey/Project/Assets/PNG/Boutons/SAVE.png').convert_alpha()
load_img : pygame.Surface = pygame.image.load('GodSmith Odyssey/Project/Assets/PNG/Boutons/LOAD.png').convert_alpha()
save_imgOver : pygame.Surface = pygame.image.load('GodSmith Odyssey/Project/Assets/PNG/Boutons/SAVE1.png').convert_alpha()
load_imgOver : pygame.Surface = pygame.image.load('GodSmith Odyssey/Project/Assets/PNG/Boutons/LAOD1.png').convert_alpha()

GREEN = (144, 201, 120)
WHITE = (255, 255, 255)
RED = (200, 25, 25)

font : pygame.font.Font = pygame.font.Font('GodSmith Odyssey/Project/Assets/Fonts/Unbounded-Regular.ttf', 30)
...
while run:
	...
	if save_button.draw(screen, True):
		#save level data
		with open(f"GodSmith Odyssey/Project/Levels/level{level}_data.csv", "w") as file:
