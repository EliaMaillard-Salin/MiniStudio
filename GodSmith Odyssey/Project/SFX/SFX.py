...
class Sound:
    ...
    def __init__(self):
        ...
        self.soundThemeList : list = ['GodSmith Odyssey/Project/Assets/Sounds/OST_Jeux_Main_Menu.mp3', 'GodSmith Odyssey/Project/Assets/Sounds/Athena.mp3', 'GodSmith Odyssey/Project/Assets/Sounds/a_travers_la_Grece.mp3', 'GodSmith Odyssey/Project/Assets/Sounds/Pour_Aglae.mp3']

        #soubdSFXList : [Dash, Jump, Death]
        self.soundSFXList : list = ['GodSmith Odyssey/Project/Assets/Sounds/Godash.mp3', 'GodSmith Odyssey/Project/Assets/Sounds/GoJump.mp3', 'GodSmith Odyssey/Project/Assets/Sounds/Goroblox-death-sound-effect.mp3']
