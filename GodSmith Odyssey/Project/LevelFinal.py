...
EndLevel :pygame.Surface = pygame.transform.scale(pygame.image.load("GodSmith Odyssey/Project/Assets/PNG/Asset Batiment/Temple/Entrée du temple/Visuel Final.png"), (832,800))

loading_level_data = load_level("GodSmith Odyssey/Project/Levels/level1_data.csv")
...
backGround = pygame.image.load("GodSmith Odyssey/Project/Assets/PNG/BackGround.png")
    ...
    if menu.status_pause == False:    
            if stop != 1:
                for i in allMobs:
                    i.CollisionBot(player)
                player.Movement(dt)
>>>>>>> 090bdcc5069d392e8a571bb214aa9818f05f59d7
