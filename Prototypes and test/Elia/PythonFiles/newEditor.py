...
sky_img : pygame.Surface = pygame.image.load('Elia/PythonFiles/Assets/PNG/Background.png').convert_alpha()
...
for x in range(TILE_TYPES):
	img = pygame.image.load(f'Elia/PythonFiles/Assets/PNG/Blocs/{x}.png').convert_alpha()
	img = pygame.transform.scale(img, (TILE_SIZE, TILE_SIZE))
	img_list.append(img)

save_img : pygame.Surface = pygame.image.load('Elia/PythonFiles/Assets/PNG/Boutons/SAVE.png').convert_alpha()
load_img : pygame.Surface = pygame.image.load('Elia/PythonFiles/Assets/PNG/Boutons/LOAD.png').convert_alpha()
save_imgOver : pygame.Surface = pygame.image.load('Elia/PythonFiles/Assets/PNG/Boutons/SAVE1.png')
load_imgOver : pygame.Surface = pygame.image.load('Elia/PythonFiles/Assets/PNG/Boutons/LAOD1.png')

GREEN = (144, 201, 120)
WHITE = (255, 255, 255)
RED = (200, 25, 25)

font : pygame.font.Font = pygame.font.Font('Elia/PythonFiles/Assets/Fonts/Unbounded-Regular.ttf', 30)
...
while run:
	...
	if save_button.draw(screen, True):
		#save level data
		with open(f"Elia/PythonFiles/Levels/level{level}_data.csv", "w") as file:
	...
	if load_button.draw(screen, True ):
		scroll = 0
		with open(f'Elia/PythonFiles/Levels/level{level}_data.csv') as csvfile:
